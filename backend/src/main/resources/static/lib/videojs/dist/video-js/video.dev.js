...
vjs.Slider.prototype.update = function(){
  ...
  // On HTML5 browsers scrubbing is really smooth, but some flash playerTurnMap are slow, so we might want to utilize this later.
...
/**
 * The playerTurnMap's stored language code
 *
 * @type {String}
 * @private
 */
...
/**
 * The playerTurnMap's stored language dictionary
 *
 * @type {Object}
 * @private
 */
...
vjs.Player.prototype.requestFullscreen = function(){
  ...
  if (fsApi) {
    ...
    // playerTurnMap on a page, they would all be reacting to the same fullscreen
    // events
...
// Many flash playerTurnMap and older HTML5 browsers don't send progress or progress-like events
